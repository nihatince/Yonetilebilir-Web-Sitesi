	 ...
	 <div class="container pt-5 pb-5">        
      <table class="table"> 
       ...
       <tbody>
        ...
        $query = $DBcon->query('SELECT * FROM log ORDER BY id ASC',PDO::FETCH_ASSOC);
          ...
          foreach($query as  $row){
            ...
            ?>
            	...
            	<td data-target=""><?=$row['giris_tarihi']?></td>
            	<td data-target="" ><?=$row['cikis_tarihi']?></td>
              <td data-target="" ><?=$row['log_ip']?></td>
