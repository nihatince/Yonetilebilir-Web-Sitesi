	 ...
	 <div class="container pt-5 pb-5">        
      <table class="table"> 
       ...
       <tbody>
        ...
        $query = $DBcon->query('SELECT * FROM konaklama ORDER BY id ASC',PDO::FETCH_ASSOC);
          ...
          foreach($query as  $row){
            ...
            ?>
              ...
              {
                ?>
              <td data-target="resim" ><img width="150px" height="100px" src="../img/konaklama/<?=$row['resim']?>"></td>
<?php
              }
                    ?>
                    <td><a href="konaklamaupdate.php?id=<?php echo $row['id']?>"><i class="fa-solid fa-pen-to-square" style='font-size:27px'></i></a></td>
