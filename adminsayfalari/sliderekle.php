  ...
  <div class="container-fluid">
    ...
    <div class="con">  
            ...
            <form id="contt" action="" method="POST" enctype="multipart/form-data">
             <center> <h3>Ekle</h3>
              <h4>Slider Ekle</h4></center>

                <fieldset>Slider Resim Yolu
          ...
          <input type="file" class="form-control" name="file"/> 
              ...
              <fieldset>
                  ...
                  <button id="contt" type="submit" class="btn btn-success btn-block" name="upload">Slider Ekle</button>
              </fieldset>
    ...
    <?php 
            ...
            {   
             ...
             if(move_uploaded_file($file_loc,$folder.$final_file))
             {
              ...
              $ekle = $DBcon->exec("INSERT INTO slider (file_name) VALUES ( '$final_file')");
              $guncelle= $DBcon->exec("UPDATE slider SET durum='1' ");
                

              
             
              echo "<script type='text/javascript'>alert('Başarıyla Yüklendi');</script>";
