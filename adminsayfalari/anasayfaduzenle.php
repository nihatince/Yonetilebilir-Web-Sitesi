	 ...
	 <div class="container pt-5 pb-5">        
      <table class="table"> 
       ...
       <tbody>
        ...
        $query = $DBcon->query('SELECT * FROM lokasyonbaslik ORDER BY id ASC',PDO::FETCH_ASSOC);
          ...
          foreach($query as  $row){
            ...
            ?>
                ...
                <td></td>
                    <td><a href="anasayfaupdate.php?id=<?php echo $row['id']?>"><i class="fa-solid fa-pen-to-square" style='font-size:27px'></i></a></td>
        ...
        $query = $DBcon->query('SELECT * FROM odalarimiz ORDER BY id ASC',PDO::FETCH_ASSOC);
          ...
          foreach($query as  $row){
            ...
            ?>
              ...
              {
                ?>
              <td data-target="resim" ><img width="200px" height="100px" src="../img/anasayfa/icerik/<?=$row['resim']?>"></td>
<?php
              }
                    ?>
                    <td><a href="odalarimizupdate.php?id=<?php echo $row['id']?>"><i class="fa-solid fa-pen-to-square"style='font-size:27px'  ></i></a></td>
